        ...
        .map(function (value1,index1,array1) {
          ...
          if(0xD800 <= value1.charCodeAt(0) && value1.charCodeAt(0) <= 0xDBFF) {
            ...
            if (isNaN(low)) {
              ...
              value1 = value 1 + array1[index1+1]
